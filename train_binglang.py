...
def train():
    ...
    # 加载训练集数据
    ds = CityScapesBingLang(dspth, mode='train', cropsize=cropsize, randomscale=randomscale)
    ...
    # exit(0)
     # 加载验证集数据
    dsval = CityScapesBingLang(dspth, mode='val', cropsize=cropsize, randomscale=randomscale)
    ...
    for it in range(max_iter):
        ...
        lossp = criteria_p(out, lb)     # out.shape = (class, w, h)
