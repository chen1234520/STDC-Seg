...
def train():
    ...
    dspth = '/root/chenguang/data/shengxiancheng'
    ...
    dist.init_process_group(
                backend = 'nccl',
                init_method = 'tcp://127.0.0.1:33278',
    ...
    ## model
    ignore_idx = 255
    net = BiSeNet_cutNet(backbone=args.backbone, n_classes=n_classes, pretrain_model=args.pretrain_path, 
